...
import { LogIn, UserPlus, GraduationCap, Briefcase, Mail } from "lucide-react";
      ...
      <div className="max-w-md w-full space-y-8">
        ...
        <div className="bg-white rounded-2xl shadow-sm border border-gray-200 p-6 space-y-4">
          ...
          <div className="space-y-3">
            {/* Student Register */}
            <button
              onClick={() => signIn("google-register-student", { callbackUrl: "/dashboard" })}
              className="w-full flex items-center justify-between px-6 py-4 bg-blue-50 border-2 border-blue-200 text-blue-700 rounded-lg hover:bg-blue-100 hover:border-blue-300 transition-all font-medium group"
            >
            ...
            {/* Alumni Register */}
            <button
              onClick={() => signIn("google-register-alumni", { callbackUrl: "/dashboard" })}
              className="w-full flex items-center justify-between px-6 py-4 bg-gray-50 border-2 border-gray-200 text-gray-700 rounded-lg hover:bg-gray-100 hover:border-gray-300 transition-all font-medium group"
            >
              <div className="flex items-center gap-3">
