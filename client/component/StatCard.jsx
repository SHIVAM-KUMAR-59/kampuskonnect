...
export default function StatCard({ label, value, context }) {
  return (
    <div className="relative group animate-in fade-in duration-500">
      <div className="absolute inset-0 bg-linear-to-br from-green-50 to-green-100 rounded-2xl opacity-0 group-hover:opacity-100 transition-opacity duration-300" />
